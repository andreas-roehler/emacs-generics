;;; ar-forward-forms.el -- Go to the end of forms -*- lexical-binding: t; -*-
...
Optional BOL: go to beginning of line following end-position"
  (interactive)
  (let (erg)
    (unless (setq erg (ar--end-base (quote ar-block-re) orig (or bol (bolp))))
      (skip-chars-forward " \t\r\n\f")
      (setq erg (ar--end-base (quote ar-block-re) orig (or bol (bolp)))))
    erg))
...
(provide 'ar-forward-forms)
;;; ar-forward-forms.el ends here

;;; ar-mode-test.el --- tests for Emacs SomeMode-mode.el
...
;; A couple of test cases for SomeMode-mode.el
...
(setq SomeMode-mode-syntax-tests
      (list
       'erste-tqs-syntax-test))

(defun ar-run-syntax-tests (&optional arg)
  (interactive "p")
  (dolist (ele SomeMode-mode-syntax-tests)
    (funcall ele arg)))

(defun ar-bug-tests-intern (testname &optional arg teststring)
  (if arg
      (progn
        ...
        (unless (< 1 arg)
          ...
          (cond ((processp (get-process "SOME3")) (kill-process "SOME3"))
                ((processp (get-process "SOME2")) (kill-process "SOME2"))
                ((processp (get-process "SOME")) (kill-process "SOME")))
...
def grep(ui, repo, pattern, \*pats, \*\*opts):
    ...
    SOME/Perl regexps. It searches repository history, not the
...
"))
  ...
  (ar-bug-tests-intern 'erste-tqs-syntax-base arg teststring)))
...
(provide 'ar-mode-syntax-test)
;;; ar-mode-test.el ends here

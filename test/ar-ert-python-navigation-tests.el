;;; ar-ert-python-navigation-tests.el --- python-mode navigation tests  -*- lexical-binding: t; -*-
...
(ert-deftest ar-ert-moves-up-minor-block-bol-sqyjbT-KaTTq2 ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
    ...
    def f():
      ...
      'python-mode
    (goto-char (point-max))
    (ar-up-minor-block-bol)
    (should (looking-at " +if a:"))))

(ert-deftest ar-ert-moves-up-block-bol-u0LDDH-OcJjMV ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-ert-moves-up-block-w7eExs-Gg9b6O ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-ert-moves-backward-block-w7eExs-QrymnI ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-ert-moves-up-minor-block-bol-2-IrCqCB ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-ert-moves-up-def-bol-wTMxJq-KMclSu ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-ert-moves-up-class-bol-hObRZJ-cDUW2n ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-ert-moves-up-def-or-class-bol-2-UDtFbh ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-ert-moves-down-block-bol-1-e6MBka ()
  (ar-generics-test-point-min
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
    in which keys were inserted.
...
(ert-deftest ar-ert-moves-down-def-bol-1-k3V8r3 ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-ert-moves-down-def-or-class-bol-1-82GNQR ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-ert-moves-down-block-1-wznp1L ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-ert-moves-down-minor-block-1-KGpcdA ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-ert-moves-down-minor-block-bol-1-Ebh0gu ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-ert-moves-down-def-1-2Dlxio ()
  (ar-generics-test-point-min
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-ert-moves-down-def-or-class-1-ym0d05 ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
"
      'python-mode
    (goto-char (point-max))
    (should (eq 332 (ar-backward-statement-bol)))))

(ert-deftest ar-ert-moves-backward-block-bol-x9If7W-IHEoCT ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
"
    ...
    (goto-char (point-max))
    (indent-to 12)
    (should (eq 317 (ar-backward-block-bol)))))
...
(ert-deftest ar-ert-moves-backward-clause-bol-RpODhD-GshxqN ()
  (ar-generics-test
    ...
    def f():
      ...
      'python-mode
    (goto-char (point-max))
    (should (eq 317 (ar-backward-clause-bol)))))
...
(ert-deftest ar-ert-moves-backward-block-or-clause-bol-ZDM7aD-8EAgcH ()
  (ar-generics-test
    ...
    def f():
      ...
      'python-mode
    (goto-char (point-max))
    (should (eq 317 (ar-backward-block-or-clause-bol)))))
...
"
    ...
    (goto-char (point-max))
    (goto-char 576)
    (should (eq 594 (ar-forward-clause-bol)))))
...
(ert-deftest ar-ert-moves-up-position-tests-12-AJXhT7 ()
  (ar-generics-test
      "class kugel(object):
...
(ert-deftest ar-ert-backward-def-or-class-1-iuGWZ9 ()
  (ar-generics-test
...
(ert-deftest ar-backward-statement-test-1-QcNOgE ()
  (ar-generics-test
      "# -*- coding: utf-8 -*-
print dir()
c = Cat()
...
(ert-deftest ar-ert-end-of-def-or-class-test-1-ibbr7d ()
  (ar-generics-test
...
(ert-deftest ar-ert-forward-indent-test-1-D3Bcke ()
  (ar-generics-test-point-min
      "class A(object):
    def a(self):
        sdfasde
...
(ert-deftest ar-forward-def-or-class-1-cmHY16 ()
  (ar-generics-test
...
(ert-deftest ar-forward-block-1-Ex3K59 ()
  (ar-generics-test-point-min
      "if True:
    def bar():
        pass
...
(ert-deftest ar-forward-clause-lp-1630952-1-HFqYAb ()
  (ar-generics-test
      "def foo(arg1, arg2, arg3):
    '''print decorated function call data to stdout.
    '''
...
(ert-deftest ar-up-block-test-Ek86Xk-GRei3c ()
  (ar-generics-test
      "
def foo():
    if True:
...
(ert-deftest ar-forward-def-or-class-test-1-YpTSCo ()
  (ar-generics-test
      "class foo:
    \"\"\"asdf\"\"\"
    def bar():
...
(ert-deftest ar-down-statement-test-1-zsvwPG ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-backward-minor-block-test-1-OLNs0Y ()
  (ar-generics-test
      "class OrderedDict1(dict):
    \"\"\"
    This implementation of a dictionary keeps track of the order
...
(ert-deftest ar-forward-block-or-clause-test-1-FCZrch ()
  (ar-generics-test
      "def main():
    if len(sys.argv) == 1:
        usage()
...
(ert-deftest ar-backward-def-or-class-text-IZvvZ5 ()
  ...
  "
      'python-mode
    (goto-char (point-max))
    (should (eq nil (ar-backward-def-or-class)))))
...
(ert-deftest ar-py-block-test-TsUyyc ()
  (ar-generics-test-point-min
      "def main():
    if len(sys.argv) == 1:
        usage()
...
(ert-deftest ar-up-string-test-DVKVO2 ()
  (ar-generics-test
    ...
    ;; (and ar-debug-p (message "py-version: %s" ar-version))
    (font-lock-ensure)
    ;; (sit-for 0.1)
    (ar-up)
    (should (eq (char-after) 34))
...
(ert-deftest ar-down-test-4dAZaV ()
  (ar-generics-test-point-min
      "def example3\(\):
...
(provide 'ar-ert-python-navigation-tests)
